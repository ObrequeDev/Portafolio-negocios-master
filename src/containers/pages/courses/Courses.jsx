        ...
        <FullWidthLayout>
            ...
            <div className=" px-4 sm:px-6">
                    <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                            <div className=" mt-2">
                            <h3 className="text-xl md:text-2xl leading-6 font-gilroy-bold text-gray-900 dark:text-dark-txt">Nuevos Cursos</h3>
                            </div>
                        </div>
                </div>
            ...
            <div className=" px-4 sm:px-6">
                    <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                            <div className=" mt-2">
                            <h3 className="text-xl md:text-2xl leading-6 font-gilroy-bold text-gray-900 dark:text-dark-txt">Los Mas Vendidos</h3>
                            </div>
                        </div>
                </div>
