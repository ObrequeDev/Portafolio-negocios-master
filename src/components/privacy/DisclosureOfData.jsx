    ...
    return (
        <div className="relative px-4 sm:px-6 lg:px-8 font-worksans-light">
            <div className="text-lg max-w-prose mx-auto">
                <h4>
                    <span className="block text-base mt-8 text-blue-600 tracking-wide uppercase font-gilroy-semibold">
                    Divulgación de datos
                    </span>
                </h4>
                <p className="mt-4 text-xl text-gray-500 leading-8 font-gilroy-regular">
                Requisitos legales
                </p>
            </div>
            ...
            <div className="mt-6 prose prose-bblue prose-lg text-gray-500 mx-auto">
                <p className="mt-4 text-xl text-gray-500 leading-8 font-gilroy-regular">
                ObrequeDev puede revelar sus Datos Personales si cree de buena fe que dicha acción es necesaria para:
                </p>
                <ul className="font-gilroy-regular">
                    <li>Para cumplir con una obligación legal</li>                     
                    <li>Para proteger y defender los derechos o la propiedad de Obreque Developers</li>                     
