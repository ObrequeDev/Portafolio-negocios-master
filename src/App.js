...
import EcommerceKubo from 'containers/pages/productos/EcommerceKubo';
    ...
    <Provider store={store}>
      <Router>
        <Routes>
          ...
          <Route path="/objetivo" element={<Datasets/>}/>
          ...
          {/* Productos */}
          <Route path="/producto/ecommerce-kubo" element={<EcommerceKubo/>}/>
